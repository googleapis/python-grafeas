...
from grafeas.grafeas_v1.types import slsa_provenance_zero_two as g_slsa_provenance_zero_two
...
class InTotoStatement(proto.Message):
    ...
    slsa_provenance_zero_two: g_slsa_provenance_zero_two.SlsaProvenanceZeroTwo = proto.Field(
        proto.MESSAGE,
        number=6,
        oneof='predicate',
